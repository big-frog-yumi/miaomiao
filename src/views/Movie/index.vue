...
.movie_menu .hot_item{ float: left;font-size: 15px; color:#666; width:80px; text-align:center; margin:0 12px; font-weight:700;    vertical-align: inherit;}
.movie_menu .hot_item.active{ float: left;vertical-align: inherit;color: #ef4238; border-bottom: 2px #ef4238 solid;}
